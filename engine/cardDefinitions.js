...
export const CARD_DEFS = {
  ...
  神の啓示: { cardId: 304, name: "神の啓示", type: CARD_TYPES.EVENT, cost: 2, theme: "パラディン", effect: "ストレージからカードを1枚選び、デッキの一番上に置く。次のターン、そのカードのコストを-3する。" },
  聖騎士ライル: { cardId: 305,
    theme: "パラディン",
  ...
  聖旗: { cardId: 308, name: "聖旗", type: CARD_TYPES.EVENT, cost: 5, theme: "パラディン", effect: "『天啓の聖女ジャンヌ・ダルク』1体と『忠義の騎士ジル・ド・レェ』1体を自分の場に出す。4ターン目以降にこの効果で特殊召喚された『天啓の聖女ジャンヌ・ダルク』は《超越》する。" },
  大天使ミカエル: { cardId: 309,
    theme: "パラディン",
