...
export const CARD_DEFS = {
  ...
  投石: { name: "投石", type: CARD_TYPES.EVENT, cost: 1 },
  やり直し: { name: "やり直し", type: CARD_TYPES.EVENT, cost: 1 },
  祈り: { name: "祈り", type: CARD_TYPES.EVENT, cost: 1 },
  痛いのは嫌なので: { name: "痛いのは嫌なので", type: CARD_TYPES.EVENT, cost: 2 },
  用意周到: { name: "用意周到", type: CARD_TYPES.EVENT, cost: 3 },
  明日から本気出す: { name: "明日から本気出す", type: CARD_TYPES.EVENT, cost: 3 },
  シールドバッシュ: { name: "シールドバッシュ", type: CARD_TYPES.EVENT, cost: 5 },
  福音受けし者: {
  ...
  竜餐の祭日: { name: "竜餐の祭日", type: CARD_TYPES.EVENT, cost: 0 },
  ドラゴンの血誓: { name: "ドラゴンの血誓", type: CARD_TYPES.EVENT, cost: 1 },
  リバーススケイル: { name: "リバーススケイル", type: CARD_TYPES.EVENT, cost: 1 },
  ドラゴンの招集: { name: "ドラゴンの招集", type: CARD_TYPES.EVENT, cost: 2 },
  滝の試練: { name: "滝の試練", type: CARD_TYPES.EVENT, cost: 2 },
  エッグ・シーフ: {
    name: "エッグ・シーフ", type: CARD_TYPES.MONSTER, cost: 2, atk: 8, hp: 4,
    race: "盗賊", keywords: [],
  },
  ドラゴンの眼光: { name: "ドラゴンの眼光", type: CARD_TYPES.EVENT, cost: 3 },
  デスラトル: { name: "デスラトル", type: CARD_TYPES.EVENT, cost: 4 },
  オルレアホワイト・ドラゴン: {
